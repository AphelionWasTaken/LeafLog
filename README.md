...
# How to run it
Android - just download the APK from [Releases](https://github.com/AphelionWasTaken/LeafLog/releases/latest). Since this is a debug APK, you will need to enable sideloading apps on your device.
